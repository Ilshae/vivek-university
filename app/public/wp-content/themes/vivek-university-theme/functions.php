...
function university_files() {
  ...
  if (strstr($_SERVER['SERVER_NAME'], 'fictional-university.local')) {
    ...
    wp_enqueue_script('main-university-js', get_theme_file_uri('/bundled-assets/scripts.ba5f66254656539be318.js'), NULL, '1.0', true);
    wp_enqueue_style('our-main-styles', get_theme_file_uri('/bundled-assets/styles.ba5f66254656539be318.css'));
  }
